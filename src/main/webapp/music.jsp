            ...
            <div class="newestAlbum" id="newestAlbum">
                ...
                <div class="new-album">
                    ...
                    <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a1" music="awaken-136824">
                        <li onclick="openVideo('./video1/supershy.mp4')">
                    ...
                    <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a2" music="inspiring-dream">
                        <li onclick="openVideo('./video1/smallgirl.mp4')">
                    ...
                    <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a3" music="playful">
                        <li onclick="openVideo('./video1/klaxon.mp4')">
                    ...
                    <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a5" music="stomps-and-claps-percussion-and-rhythm">
                        <li onclick="openVideo('./video1/sticky.mp4')">
                    ...
                    <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a9" music="business-time">
                        <li onclick="openVideo('./video1/supernatural.mp4')">
                    ...
                    <div class="chart-wrap">
                        <div class="chart-div">
                            ...
                            <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a6" music="beautiful-trip">
                                <li onclick="openVideo('./video1/hypeboy.mp4')">
                                    <img class="coverImg" src="https://cdnimg.melon.co.kr/cm2/album/images/110/11/565/11011565_20220801102637_500.jpg/melon/resize/120/quality/80/optimize">
                                    
                                    <div class="song-detail">
                                        <span class="rank">3</span>
                                        <div class="songInfo">
                                            <span class="title">Hype Boy</span>
                                            <span class="singer">NewJeans</span>
                                        </div>
                                    </div>
                                    <i class="fa fa-play"></i>
                            ...
                            <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a1" music="awaken-136824">
                                <li onclick="openVideo('./video1/suddenshowe.mp4')">
                            ...
                            <ul class="each-song" data-song-id="6441ff15b5e7a75b48e399a5" music="stomps-and-claps-percussion-and-rhythm">
                                <li onclick="openVideo('./video1/qwer.mp4')">
